...
void PSOManager::BuildDefaultRootSignature()
{
	...
	const int length = 9;
	CD3DX12_ROOT_PARAMETER slotRootParameter[length];
	...
	slotRootParameter[8].InitAsConstantBufferView(4);    //其他的一些常量数据

	//图片的静态采样器集合
	auto staticSamplers = GetStaticSamplers();

	CD3DX12_ROOT_SIGNATURE_DESC rootSigDesc(length, slotRootParameter, (UINT)staticSamplers.size(),
...
void PSOManager::BuildDefaultShadersAndInputLayout()
{
	...
	//创建所有的shader文件
	mShaders["standardVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\color.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\color.hlsl"), nullptr, "PS", "ps_5_1");
	mShaders["uiSpritePS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\color.hlsl"), nullptr, "uiSpritePS", "ps_5_1");
	mShaders["uiTextPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\color.hlsl"), nullptr, "uiTextPS", "ps_5_1");
	mShaders["shadowMapVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\shadowMap.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["shadowMapPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\shadowMap.hlsl"), nullptr, "PS", "ps_5_1");
	mShaders["skyBoxVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\skyBox.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["skyBoxPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\skyBox.hlsl"), nullptr, "PS", "ps_5_1");
	mShaders["screenVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\screen.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["defaultPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\screen.hlsl"), nullptr, "PS", "ps_5_1");
	mShaders["FogPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\screen.hlsl"), nullptr, "FogPS", "ps_5_1");
	mShaders["BriSatConPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\screen.hlsl"), nullptr, "BriSatConPS", "ps_5_1");
	mShaders["GetBloomPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\screen.hlsl"), nullptr, "GetBloomPS", "ps_5_1");
	mShaders["AddBloomPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\screen.hlsl"), nullptr, "AddBloomPS", "ps_5_1");
	mShaders["BlurHorizontalFirstPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\blur.hlsl"), nullptr, "BlurHorizontalFirstPS", "ps_5_1");
	mShaders["BlurVerticalFirstPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\blur.hlsl"), nullptr, "BlurVerticalFirstPS", "ps_5_1");
	mShaders["BlurHorizontalPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\blur.hlsl"), nullptr, "BlurHorizontalPS", "ps_5_1");
	mShaders["BlurVerticalPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\blur.hlsl"), nullptr, "BlurVerticalPS", "ps_5_1");
	mShaders["BlurCopyPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\blur.hlsl"), nullptr, "BlurCopyPS", "ps_5_1");
	
	mShaders["lakeVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\lake.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["lakePS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\lake.hlsl"), nullptr, "PS", "ps_5_1");
	mShaders["oceanVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\fftOcean.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["oceanPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\fftOcean.hlsl"), nullptr, "PS", "ps_5_1");

	mShaders["animatorVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\color.hlsl"), skinnedDefines, "VS", "vs_5_1");
	mShaders["shadowMapAnimatorVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\shadowMap.hlsl"), skinnedDefines, "VS", "vs_5_1");

	mShaders["cubeTargetReflectVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\cubeTargetReflect.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["cubeTargetReflectPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\cubeTargetReflect.hlsl"), nullptr, "PS", "ps_5_1");

	mShaders["skullVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\skull.hlsl"), nullptr, "VS", "vs_5_1");
	mShaders["skullGS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\skull.hlsl"), nullptr, "GS", "gs_5_1");
	mShaders["skullPS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\skull.hlsl"), nullptr, "PS", "ps_5_1");

	mShaders["strokeVS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\color.hlsl"), StrokeDefineds, "VS", "vs_5_1");
	mShaders["strokePS"] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\color.hlsl"), nullptr, "strokePS", "ps_5_1");
...
void PSOManager::BuildOceanComputePSO()
{
	...
	{
		string& name = str[i];
		mShaders[name] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\fftOceanCS.hlsl"), nullptr, name, "cs_5_1");
...
void PSOManager::BuildParticleComputePSO()
{
	...
	{
		string& name = str[i];
		mShaders[name] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\particleCS.hlsl"), nullptr, name, "cs_5_1");
		D3D12_COMPUTE_PIPELINE_STATE_DESC desc = {};
...
void PSOManager::BuildScriptComputePSO()
{
	...
	{
		string& name = str[i];
		mShaders[name] = d3dUtil::CompileShader(manager->getPathPrefix("Shaders\\scriptLand.hlsl"), nullptr, name, "cs_5_1");
		D3D12_COMPUTE_PIPELINE_STATE_DESC desc = {};
