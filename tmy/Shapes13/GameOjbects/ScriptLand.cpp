#include "ScriptLand.h"



ScriptLand::ScriptLand(MeshGeometry* mesh, int objIndex, string submeshName, Material* material) :GameObject(mesh, objIndex, submeshName, material)
{
